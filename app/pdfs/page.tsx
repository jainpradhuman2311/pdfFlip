  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-8">
      <header className="mb-6">
        <h1 className="text-2xl md:text-3xl font-semibold text-balance">Library</h1>
        <p className="text-muted-foreground mt-1">Browse PDFs, images, and Word documents from Google Drive.</p>
      </header>
